...
def input_dict_from_file_and_plot_steps_and_exp_reward(dict_file_q, n_file=10,
    ...
    for key in keys:
        ...
        if key == "R_reward_design_env=chain_n_states=41_len_active_set_chosen=7_expected_reward":
            ...
            plt.errorbar(range(0, up_to_power_2+2),
                     ...
                     color='#69BE28', marker=">", lw=4,markersize=15,
            ...
            plt.errorbar(range(0, up_to_power_2+2),
                     ...
                     color='#FF8849', marker="<", ls=":", lw=4, markersize=15,
            ...
            plt.errorbar(range(0, up_to_power_2+2),
                     dict_file_q[key][array_index_to_plot],
                     label=r"$\textsc{PBRS}\textnormal{-}\textsc{Abs}$",
                     color='#f0e130', marker="x", ls=":", markersize=18, lw=4,
                     yerr=dict_file_q["SE_Reward_pot"][array_index_to_plot])


    # print(dict_file)
    plt.legend(loc='upper center', bbox_to_anchor=(0.5, 1.435), ncol=2, fancybox=False, shadow=False)
    ...
    outFname = os.getcwd() + "/" + out_folder_name + "/appendix_chainkey_convergence_fixed_B_with-PBRS-Abs.pdf"
...
if __name__ == "__main__":
    ...
    average_number = int(sys.argv[1])
    n_averaged_1 = average_number
    n_averaged_2 = average_number
    n_averaged_3 = average_number
    n_averaged_4 = average_number
    n_averaged_5 = average_number

    input_dir_path_q_learning_convergence_numbers_1 = "results/parallel_PBRS_cont/Q_convergence_chain_0_1_key_each_algorithm_id=1"
    input_dir_path_q_learning_convergence_numbers_2 = "results/parallel_PBRS_cont/Q_convergence_chain_0_1_key_each_algorithm_id=2"
    input_dir_path_q_learning_convergence_numbers_3 = "results/parallel_PBRS_cont/Q_convergence_chain_0_1_key_each_algorithm_id=3"
    input_dir_path_q_learning_convergence_numbers_4 = "results/parallel_PBRS_cont/Q_convergence_chain_0_1_key_each_algorithm_id=4"
    input_dir_path_q_learning_convergence_numbers_5 = "results/parallel_PBRS_cont/Q_convergence_chain_0_1_key_each_algorithm_id=5"
    out_folder_name = "results/plots_chain_0_1"
    each_number = 800
    t = int(900000)

    tol = 1e-10

    dict_alg_1, SE_1 = input_from_file(
        input_dir_path_q_learning_convergence_numbers_1, n_file=n_averaged_1, t=t)
    dict_alg_2, SE_2 = input_from_file(
        input_dir_path_q_learning_convergence_numbers_2, n_file=n_averaged_2, t=t)
    dict_alg_3, SE_3 = input_from_file(
        input_dir_path_q_learning_convergence_numbers_3, n_file=n_averaged_3, t=t)
    dict_alg_4,SE_4 = input_from_file(
        input_dir_path_q_learning_convergence_numbers_4, n_file=n_averaged_4, t=t)
    ...
    dict_to_plot.update(dict_alg_1)
    ...
    input_dict_from_file_and_plot_steps_and_exp_reward(dict_to_plot,
                                                       n_file=n_averaged_1, out_folder_name=out_folder_name,
